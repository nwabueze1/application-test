  ...
  return <section className={styles.root}>
    <div className={styles.content}>
      <div className={clx(dmSans.className, styles.text_content)}>
        ...
        <h3 className={clx(styles.heading, tomatoFont.className)}>Join our 100,000 users investing and setting long term
          goals!</h3>
      ...
      <div>
        <Image src={"/small_phone.png"} alt={"phone image"} width={208} height={425}
