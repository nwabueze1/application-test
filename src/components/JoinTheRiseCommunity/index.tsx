    ...
    <section className={classes.root}>
      <div className={classes.section}>
        <div className={classes.text_container}>
          <h3 className={classes.heading}>Join The Rise Community</h3>
          <p className={clx(classes.description, dmSans.className)}>
            ...
            can help you along your financial journey with tips, support, advice and learning. It's
            completely free and open to new and seasoned investors.
          </p>
          <ContainedButton>Join our Community</ContainedButton>
        </div>
        <div>
          <Image
...
export const ContainedButton = ({
  ...
  return (
    <button className={clx(classes.button, tomatoFont.className, className)}>{children}</button>
  );
};
